...
namespace APIVerve
{
    public class DomainExpirationAPIClient
    {
        ...
        public DomainExpirationAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public DomainExpirationAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(domainexpirationQueryOptions options)
        {
            try
            {
                if (_isDebug)
